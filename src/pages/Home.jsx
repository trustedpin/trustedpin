...
export default function Home({ navigate }) {
  ...
  return (
    <div style={{background:'#08080E',minHeight:'100vh'}}>
      ...
      <div style={{background:'#0F0F1A',minHeight:'88vh',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'3rem 1.5rem',textAlign:'center',position:'relative',overflow:'hidden'}}>
        ...
        <h1 className="animate-up d2" style={{fontSize:'clamp(2.2rem,6vw,3.8rem)',color:'#F2EEE6',fontWeight:'800',lineHeight:'1.1',marginBottom:'0.75rem',letterSpacing:'-0.02em'}}>
          Find Your Next<br/><em style={{color:'#C9A84C',fontStyle:'italic'}}>Trusted</em> Pro
        </h1>

        <p className="animate-up d3" style={{color:'#A09880',fontSize:'1rem',maxWidth:'440px',margin:'0 auto 2.5rem',lineHeight:'1.7'}}>
          Stop scrolling through endless Google results. TrustedPin surfaces the highest-rated local contractors in seconds.
        </p>
        ...
        <div className="animate-up d4" style={{background:'#181828',border:'1px solid #252538',borderRadius:'18px',padding:'1.5rem',maxWidth:'620px',width:'100%',boxShadow:'0 24px 60px rgba(0,0,0,0.4)'}}>
          <div style={{fontSize:'0.72rem',fontWeight:'600',color:'#9A8870',textTransform:'uppercase',letterSpacing:'0.1em',marginBottom:'1rem',textAlign:'left'}}>Find a contractor near you</div>
      ...
      <div style={{padding:'3rem 1.5rem',maxWidth:'760px',margin:'0 auto'}}>
        ...
        <div style={{background:'#0F0F1A',border:'1px solid #252538',borderLeft:'3px solid #C9A84C',borderRadius:'12px',padding:'1.75rem'}}>
          ...
          {[
            ...
            ['Cross-check reviews across platforms','Look them up on Google, BBB, and Yelp. Legitimate businesses maintain consistent presence across platforms.'],
          ...
          <div style={{background:'#181828',border:'1px solid #5A5248',borderRadius:'9px',padding:'1rem',marginTop:'1.25rem',fontSize:'0.73rem',color:'#5A5248',lineHeight:'1.8'}}>
            ...
            TrustedPin aggregates publicly available information from Google and other third-party sources strictly for informational purposes. TrustedPin does not vet, background-check, verify licenses, verify insurance, or endorse any contractor listed on this platform. TrustedPin makes no representations or warranties about the accuracy, completeness, or legitimacy of any contractor or their services. Your use of this information is entirely at your own risk. TrustedPin and its affiliates are not liable for any damages, losses, or outcomes resulting from contacting or hiring any contractor found through this service.
          </div>
        </div>
      </div>
